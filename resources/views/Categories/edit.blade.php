            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        ...
                        <li class="active">
                            <a href="{{ route('categories.edit', $category->id) }}">{{ __('words.edit_cat') }}</a>
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body card-block">
                <form action="{{ route('categories.update', $category->id) }}" method="post" class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name', $category->name) }}" placeholder="{{ __('words.Enter_category_name') }}" class="form-control is-valid @error('name')is-invalid @enderror">
                            </div>
                            @error("name")
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea id="description" name="description" placeholder="{{ __('words.Enter_category_description') }}" class="form-control is-valid @error('description')is-invalid @enderror">{{ old('description', $category->description) }}</textarea>
                            </div>
                            @error("description")
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="submit" class="btn btn-success submit-btn">{{ __('words.edit_cat') }}</button>
                        </div>
                    </div>
                </form>
            </div>
